...
void qwen_bf16_matvec_fused_avx(
    ...
    for (; o + 3 < out_dim; o += 4) {
        ...
        for (; k + 32 <= in_dim; k += 32) {
            ...
            a0 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r0a), 16)), xv0, a0);
            a1 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r0b), 16)), xv1, a1);

            /* Row 1 */
            __m256i r1a = _mm256_loadu_si256((const __m256i *)(w1 + k));
            __m256i r1b = _mm256_loadu_si256((const __m256i *)(w1 + k + 16));
            a2 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r1a), 16)), xv0, a2);
            a3 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r1b), 16)), xv1, a3);

            /* Row 2 */
            __m256i r2a = _mm256_loadu_si256((const __m256i *)(w2 + k));
            __m256i r2b = _mm256_loadu_si256((const __m256i *)(w2 + k + 16));
            a4 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r2a), 16)), xv0, a4);
            a5 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r2b), 16)), xv1, a5);

            /* Row 3 */
            __m256i r3a = _mm256_loadu_si256((const __m256i *)(w3 + k));
            __m256i r3b = _mm256_loadu_si256((const __m256i *)(w3 + k + 16));
            a6 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r3a), 16)), xv0, a6);
            a7 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r3b), 16)), xv1, a7);
        }
        ...
        for (; k + 16 <= in_dim; k += 16) {
            ...
            a0 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r0), 16)), xv, a0);
            a2 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r1), 16)), xv, a2);
            a4 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r2), 16)), xv, a4);
            a6 = _mm512_fmadd_ps(
                _mm512_castsi512_ps(_mm512_slli_epi32(_mm512_cvtepu16_epi32(r3), 16)), xv, a6);
        }
