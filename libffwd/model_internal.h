 ...
 * to model_types.h: that header holds the shared struct definitions, this one the
 * shared functions. None are part of the public API (ffwd.h) and none carry
 * FFWD_API visibility; they are shared between the translation units (model
 ...
 * workspace lifecycle (ffwd_workspace_nbytes mirrors their sizing); called from
